...
irisMap   = pi3d.Texture("graphics/calci-iris.jpg"  , mipmap=False,
              filter=pi3d.constants.GL_LINEAR)
scleraMap = pi3d.Texture("graphics/calci-sclera.png", mipmap=False,
              filter=pi3d.constants.GL_LINEAR, blend=True)
lidMap    = pi3d.Texture("graphics/lid.png"   , mipmap=False,
              filter=pi3d.constants.GL_LINEAR, blend=True)
fireMap   = pi3d.Texture("graphics/calcifer.gif"   , mipmap=False,
              filter=pi3d.constants.GL_LINEAR,)
...
fire = pi3d.Lathe(path=pts, sides=64)
fire.set_textures([fireMap])
fire.set_shader(shader)
#re_axis(fire, 0)
