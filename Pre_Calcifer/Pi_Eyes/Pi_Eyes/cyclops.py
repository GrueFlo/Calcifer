...
if DISPLAY.width <= (DISPLAY.height * 2):
	...
	eyeRadius   = DISPLAY.height / 4.1
else:
	eyeRadius   = DISPLAY.height / 5
...
irisMap   = pi3d.Texture("graphics/dragon-sclera.jpg"  , mipmap=False,
              filter=pi3d.constants.GL_LINEAR)
scleraMap = pi3d.Texture("graphics/test-sclera.png", mipmap=False,
